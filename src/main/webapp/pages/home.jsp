...
<title>AgriVisionIndia Homepage</title>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-4">At AgriVision, we are dedicated to providing a comprehensive suite of services designed to empower farmers and agricultural enthusiasts with the knowledge, resources, and support they need for successful and sustainable farming practices. </p>
                ...
                <a href="/">
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                       <i  class="fa-solid fa-cloud-moon-rain display-1 text-primary mb-3"></i>
                        ...
                        <p class="mb-0">At AgriVision, we understand the pivotal role that weather conditions play in successful farming.,Access real-time weather information, including temperature, humidity  and more.</p>
                    </div></a>
                </div>
                <div class="col-lg-4 col-md-6" >
                     <a href="farmtrain">
                ...
                <div class="col-lg-4 col-md-6" >
                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                      <i  class="fa-solid fa-graduation-cap display-1 text-primary mb-3"></i>
                        ...
                        <p class="mb-0"> At  AgriVision Agro Student Training provides a distinctive platform for you to share your agricultural knowledge, offer specialized courses, and connect directly with aspiring agri-entrepreneurs and students. </p>
                    </div>
                </div>
            </div>
        </div>
