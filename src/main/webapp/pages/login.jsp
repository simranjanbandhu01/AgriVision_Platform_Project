...
<head>
    <meta charset="utf-8">
    <title>AgriVisionIndia Login</title>
  ...
  <div class="container-fluid px-5 d-none d-lg-block top_bar">
                    ...
                    <div class="bg-secondary h-100 p-5">
                        ...
                        <div class="d-flex mb-4">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">simranjanbandhu01@gmail.com</span>
                            </div>
                        </div>
                        <div class="d-flex">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-3">
                                ...
                                <span class="text-white">+91 7875178466</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">AgriVision.Com</a>. All Rights Reserved. Designed And Developed by <a class="text-secondary fw-bold" href=>Simran Janbandhu</a></p>
        </div>
    </div>
    <!-- Footer End -->
